    ...
    { type: 'separator' },
    {
      ...
      click: () => {
        ...
        if (fs.existsSync(logPath)) {
          ...
          // `activate` is not optional: without a Dock tile this process is
          // an accessory app, so a Terminal window opened from here lands
          // behind whatever the user was looking at.
          exec(`osascript -e 'tell application "Terminal" to activate' -e 'tell application "Terminal" to do script "tail -f \\"${logPath}\\""'`);
        } else {
