...
# then the generated VERSION file, then `git describe --tags`, then the legacy
# macOS/package.json) lives in ONE place: src/core/version.py. Do not add a
# second resolver here or anywhere else. On total failure the resolver returns
# "" so the chip renders blank rather than a wrong literal.
#
