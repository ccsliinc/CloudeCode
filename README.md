...
**macOS (Apple Silicon):** [Cloude.Code-0.7.5-arm64.dmg](https://github.com/Adoom666/CloudeCode/releases/download/v0.7.5/Cloude.Code-0.7.5-arm64.dmg) (93 MB)
...
```bash
shasum -a 256 "Cloude.Code-0.7.5-arm64.dmg"
# expected: 236a08f7d0b7f1b5e80ce421ed1c16f2b1cbc6b50036d513b2d842c10b2807e0
```
...
1. Grab `Cloude.Code-0.7.5-arm64.dmg` from releases (or build from source — see below).
